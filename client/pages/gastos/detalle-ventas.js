...
export default function DetalleVentas() {
  ...
  return (
    <div>
      <h1 className="text-xl font-semibold mb-4">Detalle de Ventas</h1>
      <p className="text-sm text-gray-600 mb-4">
        GL20000 filtrado por rango de cuentas, mostrando solo ORGNTSRC = SLSTE (facturas de
        venta). Para controlar contra el reporte de Ventas (SOP30200).
      </p>
      ...
      {data && <ResultTable title="Detalle de Ventas" rows={data.ventas.rows} columns={data.ventas.columns} filename="detalle-ventas" />}
    </div>
  );
}
